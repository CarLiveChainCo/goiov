...
import (
	"crypto/ecdsa"
	"fmt"
	"github.com/carlivechain/goiov/contracts/appmanager"
	"io/ioutil"
	"math/big"
	"os"
	"path/filepath"
	...
	"github.com/carlivechain/goiov/common/fdlimit"
...
func MakeChain(ctx *cli.Context, stack *node.Node) (chain *core.BlockChain, chainDb ethdb.Database) {
	...
	if ctx.GlobalBool(TestgiovFlag.Name) {
		flag = true
	} else {
		flag = false
	}
	if config.Alien != nil {
		config.Alien.AppId = config.AppId
		engine = alien.New(config.Alien, chainDb, flag)
	}
